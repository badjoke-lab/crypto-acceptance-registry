...
export default async function GeneratedDetailPage({ params }: GeneratedDetailPageProps) {
  ...
  if (!merchant) {
    return (
      <main style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
        <h1>Generated record not found</h1>
        <p>No generated product merchant matched this id.</p>
        <Link href="/generated">Back to generated catalog</Link>
      </main>
    )
  }
  ...
  return (
    <main style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <p><Link href="/generated">← Back to generated catalog</Link></p>
